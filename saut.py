...
# Music
pygame.mixer.music.load('asset/Gerudo Valley - The Legend of Zelda Ocarina Of Time.mp3')
...
sprite_sheet_path = 'asset/run_sheet.png'
...
frame_j_width = 500
frame_j_height = 700
jumping_frames = [jump_sheet.subsurface(pygame.Rect(i * frame_j_width, 0, frame_j_width, frame_j_height)) for i in
                  range(5)]

# mechant
frame_m_width = 200
frame_m_height = 700
mechant_frames = [villain_sheet.subsurface(pygame.Rect(i * frame_m_width, 0, frame_m_width, frame_m_height)) for i in
                  range(13)]

# mechant2
frame_m2_width = 200
frame_m2_height = 700
mechant2_frames = [villain2_sheet.subsurface(pygame.Rect(i * frame_m2_width, 0, frame_m2_width, frame_m2_height)) for i
                   in range(13)]

# dancer
frame_d_width = 210
frame_d_height = 700
dancer_frames = [dancer_sheet.subsurface(pygame.Rect(i * frame_d_width, 0, frame_d_width, frame_d_height)) for i in
                 range(2)]

# dancer2
frame_d2_width = 210
frame_d2_height = 700
dancer2_frames = [dancer2_sheet.subsurface(pygame.Rect(i * frame_d2_width, 0, frame_d2_width, frame_d2_height)) for i in
                  range(2)]

# dancer3
frame_d3_width = 210
frame_d3_height = 700
dancer3_frames = [dancer3_sheet.subsurface(pygame.Rect(i * frame_d3_width, 0, frame_d3_width, frame_d3_height)) for i in
                  range(2)]

# Resizing frames
scaled_frame_width = int(frame_width * scale_factor)
scaled_frame_height = int(frame_height * scale_factor)
running_frames_scaled = [pygame.transform.scale(frame, (scaled_frame_width, scaled_frame_height)) for frame in
                         running_frames]

# jump
scaled_frame_j_width = int(frame_j_width * scale_factor)
scaled_frame_j_height = int(frame_j_height * scale_factor)
jumping_frames_scaled = [pygame.transform.scale(frame, (scaled_frame_j_width, scaled_frame_j_height)) for frame in
                         jumping_frames]

# mechant
scaled_frame_m_width = int(frame_m_width * scale_m_factor)
scaled_frame_m_height = int(frame_m_height * scale_m_factor)
mechant_frames_scaled = [pygame.transform.scale(frame, (scaled_frame_m_width, scaled_frame_m_height)) for frame in
                         mechant_frames]

# mechant2
scaled_frame_m2_width = int(frame_m2_width * scale_m2_factor)
scaled_frame_m2_height = int(frame_m2_height * scale_m2_factor)
mechant2_frames_scaled = [pygame.transform.scale(frame, (scaled_frame_m2_width, scaled_frame_m2_height)) for frame in
                          mechant2_frames]

# dancer
scaled_frame_d_width = int(frame_d_width * scale_d_factor)
scaled_frame_d_height = int(frame_d_height * scale_d_factor)
dancer_frames_scaled = [pygame.transform.scale(frame, (scaled_frame_d_width, scaled_frame_d_height)) for frame in
                        dancer_frames]

# dancer2
scaled_frame_d2_width = int(frame_d2_width * scale_d2_factor)
scaled_frame_d2_height = int(frame_d2_height * scale_d2_factor)
dancer2_frames_scaled = [pygame.transform.scale(frame, (scaled_frame_d2_width, scaled_frame_d2_height)) for frame in
                         dancer2_frames]

# dancer3
scaled_frame_d3_width = int(frame_d3_width * scale_d3_factor)
scaled_frame_d3_height = int(frame_d3_height * scale_d3_factor)
dancer3_frames_scaled = [pygame.transform.scale(frame, (scaled_frame_d3_width, scaled_frame_d3_height)) for frame in
                         dancer3_frames]
